...
const ICONS: Record<string, JSX.Element> = {
  ...
  travel:    <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M14 8c0-.3-.2-.55-.45-.65L8.75 5.6V2.3c0-.45-.35-.8-.75-.8s-.75.35-.75.8v3.3L2.45 7.35C2.2 7.45 2 7.7 2 8c0 .4.35.7.75.65L7.25 7.85v3.25l-1.35.75c-.15.1-.25.25-.25.45v.65c0 .3.3.5.6.4l1.5-.5 1.5.5c.3.1.6-.1.6-.4v-.65c0-.2-.1-.35-.25-.45L8.25 11.1V7.85l4.5.8C13.65 8.7 14 8.4 14 8z" fill="currentColor"/></svg>,
