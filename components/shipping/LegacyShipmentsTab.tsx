...
// Legacy ad-hoc Shipping Log. Pre-dates the per-event return-shipping
// system (event_shipments). Kept around as a tab inside the Shipping
// page so the existing workflow isn't broken; new work happens in the
// Event Returns tab.
...
export default function LegacyShipmentsTab() {
