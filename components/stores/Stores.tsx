...
import StoreShareUrlCard from './StoreShareUrlCard'
    ...
    <div onClick={e => e.target === e.currentTarget && onClose()}
      ...
      <div onClick={e => e.stopPropagation()}
        ...
        <div style={{ padding: 24, display: 'flex', flexDirection: 'column', gap: 20 }}>
          ...
          {/* Store-owner Dashboard URL (one per store, with event
              picker on the public page). Distinct from Store Portal
              Access: that token is for store EMPLOYEES booking
              appointments; this token is for the store OWNER to watch
              live event progress. */}
          <StoreShareUrlCard storeId={store.id} ownerEmail={store.owner_email} />
